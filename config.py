...
FEEDER_LINK_ELEVASION_THRESHOLD_DEG = 20.0  # Minimum elevation angle for feeder links
...
# Dimensions are s and m (values are not realistic, just for testing)
LINK_PARAMS: dict[LinkType, LinkParams] = {
    LinkType.INTRA_PLANE_ISL: LinkParams(
        # Link Up/down parameters
        mttf_ref=1_000, d_ref=2400_000, mttr=50,  gamma_fail=0.5,
        # PER parameters
...
# ---fiveQI table (PER, latency)------
FIVEQI_TABLE = {
    1: (1e-5, 0.01),  # URLLC control traffic
    5: (1e-3, 0.1),   # eMBB video traffic
